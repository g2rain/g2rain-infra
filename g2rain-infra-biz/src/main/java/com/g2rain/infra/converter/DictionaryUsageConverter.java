...
public interface DictionaryUsageConverter {

    /**
     * 单例实例，通过 {@link Mappers#getMapper(Class)} 获取 MapStruct 自动生成的实现。
     */
    DictionaryUsageConverter INSTANCE = Mappers.getMapper(DictionaryUsageConverter.class);
    ...
    DictionaryUsageVo po2vo(DictionaryUsagePo po);
    ...
    DictionaryUsagePo dto2po(DictionaryUsageDto dto);
}
